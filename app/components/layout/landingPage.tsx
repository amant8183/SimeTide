  ...
  const features = [
    {
      ...
      description: "Real-time data from OKX, Bybit, and Deribit exchanges"
    },
    {
      icon: "⚡",
      title: "Live API Integration", 
      description: "Fetches real instrument specifications from all exchanges"
    },
    {
      icon: "🎯",
      title: "Exchange-Specific Formatting",
      description: "Prices and amounts formatted per exchange rules"
    },
    {
      icon: "🔄",
      title: "Real-time Updates",
      description: "Live orderbook data with WebSocket connections"
    },
    {
      icon: "📱",
    ...
    },
    {
      ...
      description: "Test trading strategies with realistic market impact"
    }
  ];
