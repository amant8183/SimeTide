...
import type { Venue, AnyInstrument, OrderbookEntry, SimulatedOrder, OrderbookData } from '../../types/domain'
...
const Orderbook = ({ venue, instrument, simulatedOrder }: OrderbookProps) => {
  ...
  const instrumentId = instrument ? (instrument as any).instId || (instrument as any).symbol || (instrument as any).instrument_name : null;
        ...
        <div className="flex flex-col">
          ...
          {instrument && (
            <div className="text-xs text-txtSecondary">
              ...
              <div className="mt-1">
                {instrument.exchange === 'Deribit' && (
                  <span className="ml-2 text-blue-400">
                    {(instrument as any).instrument_type?.toUpperCase()}
                  </span>
                )}
              </div>
            </div>
