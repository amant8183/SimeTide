  ...
  try {
    switch (venue) {
      ...
      case 'Deribit':
        ...
        if (btcData.result) deribitInstruments.push(...btcData.result.filter((i: any) => i.is_active).map((inst: any): DeribitInstrument => ({
            exchange: 'Deribit',
        ...
        if (ethData.result) deribitInstruments.push(...ethData.result.filter((i: any) => i.is_active).map((inst: any): DeribitInstrument => ({
            exchange: 'Deribit',
            instrument_name: inst.instrument_name,
            base_currency: inst.base_currency,
            quote_currency: inst.quote_currency,
